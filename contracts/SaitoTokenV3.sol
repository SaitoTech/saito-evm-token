...
contract SaitoTokenV3 is ERC20 {
  ...
  function setOwner2(address newOwner) public virtual {
    require(msg.sender == owner1);
    require(owner2 == 0x0000000000000000000000000000000000000000);
    owner2 = newOwner;
  }
  
  function setOwner3(address newOwner) public virtual {
    require(msg.sender == owner1);
    require(owner3 == 0x0000000000000000000000000000000000000000);
    owner3 = newOwner;
  }
